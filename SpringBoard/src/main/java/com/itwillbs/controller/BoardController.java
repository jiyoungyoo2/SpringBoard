...
public class BoardController {
	...
	public String registPOST(BoardVO vo,RedirectAttributes rttr) throws Exception{
		...
		//return "/board/list"; // 새로고침시 글쓰기 두번 입력됨
	}
...
//		cri.setPageSize(10);
	...
	public void readGET(Criteria cri,Model model,@RequestParam("bno") int bno) throws Exception{
	...
	public String removePOST(Criteria cri,/* @ModelAttribute("bno") */ /* @RequestParam("bno") */ int bno, RedirectAttributes rttr) throws Exception{
